...
// ... (ActionModal, EditItemModal, Main Component logic...)

// Để đảm bảo bạn copy đúng, tôi sẽ paste lại toàn bộ nội dung bên dưới
// Bạn chỉ cần copy hết và dán đè vào file InventoryManagement.tsx
